...
import com.tools.CameraHelper2;
import com.tools.CameraHelper2.CameraHelperException;
...
implements SurfaceHolder.Callback{
	...
	private CameraHelper2 cameraHelper; 							// helper for taking care of camera rotations and other camera stuff
	...
	protected void initializeLayout() {
		...
		cameraHelper = new CameraHelper2(Utils.IMAGE_QUALITY);
	 ...
	 */
	private CameraHelper2.OnRotationCallback onRotate = 
		new CameraHelper2.OnRotationCallback() {
	...
	protected void onResume() {
		super.onResume();
		cameraHelper.onResume(this, onRotate);
		...
		try {
			...
			Toast.makeText(ctx, "No accessible camera!", Toast.LENGTH_LONG);
			finish();
			return;
		}
	...
	private void savePicture(){
		...
		SaveTakenPictureTask<TakePicture2> task =  new SaveTakenPictureTask<TakePicture2>(
				this,
