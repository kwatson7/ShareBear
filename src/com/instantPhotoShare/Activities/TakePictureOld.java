...
import com.tools.CameraHelperOld;
import com.tools.CustomActivity;
import com.tools.MultipleCheckPopUp;

public class TakePictureOld 
...
implements SurfaceHolder.Callback{
	...
	private CameraHelperOld cameraHelper; 								// helper for taking care of camera rotations and other camera stuff
	...
	protected void initializeLayout() {
		...
		cameraHelper = new CameraHelperOld(null, Utils.IMAGE_QUALITY, false, onRotate);
	 ...
	 */
	private CameraHelperOld.OnRotationCallback onRotate = 
		new CameraHelperOld.OnRotationCallback() {
	...
	private void savePicture(){
		...
		SaveTakenPictureTask<TakePictureOld> task =  new SaveTakenPictureTask<TakePictureOld>(
				this,
