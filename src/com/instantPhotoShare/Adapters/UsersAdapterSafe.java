...
public class UsersAdapterSafe
extends TableAdapter <UsersAdapterSafe>{
	...
	public UsersAdapterSafe(Context context) {
		super(context);
		ctx = context;
	}
	...
	public long makeNewUser(
		...
		if (affected == 1){
			UsersAdapterSafe users = new UsersAdapterSafe(ctx);
	...
	public long makeNewUser(
		...
		synchronized (UsersAdapterSafe.class) {
	...
	private void combineCommonServerIds(long serverId){
		...
		UsersAdapterSafe helper = new UsersAdapterSafe(ctx);
