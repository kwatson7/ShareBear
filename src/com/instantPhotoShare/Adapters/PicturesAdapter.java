...
extends TableAdapter<PicturesAdapter>{
	 ...
	 */
	public byte[] getThumbnailServerDONTUSE(){
	...
	//TODO: go back and change all update times in sqlite database
	//TODO: update download and hasThumbnail in full to thumb converter
	/**
